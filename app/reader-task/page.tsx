...
const articles: Article[] = [
  ...
  },
  {
    ...
    abstract:
      "本文将对关于制度与经济发展的新制度经济学文献提供一个根本性的批判。作者认为,既有的文献有四宗罪(四大缺陷),而其中每个缺陷都包含更具体的不足。这四大缺陷是:概念化和度量问题、理论严谨性不足、现代辉格式神话,以及对制度变迁与发展的非进化的理解。正是这四宗罪使得新制度经济学无法给出一个关于经济发展的制度基础的系统性阐述。这一���本性批评将为作者在别的地方系统性地阐述经济发展的制度基础奠定部分基础。",
    author: "经济研究",
    time: "1周前",
    labelType: "B",
    category: "经济学理论",
