...
传统金融服务的局限性​：传统金融机构在提供绿色金融服务时，倾向于依赖规范的财务数据、足额的抵押资产或清晰的政府信用背书。然而，中小企业通常存在财务信息不规范、可抵押资产不足等问题。加之其绿色效益难以被传统方法精准量化，导致银行“不敢贷、不愿贷”，形成了所谓的“绿色悖论”——即最需要绿色金融支持的主体，反而最难获得服务。例如江苏省绿色信贷拒贷率高达70%。但也存在成功的解决方案，如共享治污的“绿岛”模式（如镇江丹徒区制刷业的油漆集中加工中心）有效破解中小企业资金技术瓶颈。
